...
class StagTWHelper {
	...
	function twitter_widget_convert_links( $status, $targetBlank = true, $linkMaxLen = 250 ) {
		...
		$status = preg_replace( '/#([A-Za-z0-9\/\.]*)/', '<a target="_new" href="http://twitter.com/search?q=$1">#$1</a>', $status );

		// Convert attags to twitter profiles in <a> links
		$status = preg_replace( '/@([A-Za-z0-9\/\.]*)/', '<a href="http://www.twitter.com/$1">@$1</a>', $status );

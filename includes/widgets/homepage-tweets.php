					...
					$br_widget_tweets  = maybe_unserialize( get_option( 'twitter_widget_br_tweets' ) );
					  ...
					  <div class="grid-6 tweets">
						<div class="tweet-header">
							<?php if ( geeklove_get_thememod_value( 'geeklove_wedding_bride_avatar' ) != '' ) : ?>
							<img src="<?php echo geeklove_get_thememod_value( 'geeklove_wedding_bride_avatar' ); ?>" alt="" class="avatar-tw">
							<?php endif; ?>

						  <h4><?php echo geeklove_get_thememod_value( 'geeklove_wedding_bride_first_name' ); ?></h4><span><a href="//twitter.com/<?php echo $br_twitter; ?>">@<?php echo $br_twitter; ?></a></span>
						</div>
					  ...
					  <div class="grid-6 tweets">
						<div class="tweet-header">
							<?php if ( geeklove_get_thememod_value( 'geeklove_wedding_bridegroom_avatar' ) != '' ) : ?>
							<img src="<?php echo geeklove_get_thememod_value( 'geeklove_wedding_bridegroom_avatar' ); ?>" alt="" class="avatar-tw">
							<?php endif; ?>

						  <h4><?php echo geeklove_get_thememod_value( 'geeklove_wedding_bridegroom_first_name' ); ?></h4><span><a href="//twitter.com/<?php echo $brg_twitter; ?>">@<?php echo $brg_twitter; ?></a></span>
						</div>
